...
# Variables
RESOURCE_GROUP="lgallusRG"
CONTAINER_NAME="lgallus-django-loan"
ACR_NAME="lgalluscontainerregistry"
ACR_LOGIN_SERVER="lgalluscontainerregistry.azurecr.io"
IMAGE_NAME="$ACR_LOGIN_SERVER/djangofi:latest"
PORT=8000
RESTART_POLICY="OnFailure"
OS_TYPE="Linux"  
API_CONTAINER_NAME="lgallus-loan-api"
...
az container create \
    ...
    --environment-variables \
        ...
        EMAIL_HOST_PASSWORD3=$EMAIL_HOST_PASSWORD3 \
        EMAIL_HOST_PASSWORD4=$EMAIL_HOST_PASSWORD4 \
        DEBUG=$DEBUG \
        DB_SERVER=$DB_SERVER \
